...
class FutureStringArray extends FutureArray {
  ...
  override at(index: number) {
    return new FutureString(this.directive.next(index));
  }

  /** Returns the result for `FutureStringArray` once it's node has been run. */
  protected override async result(): Promise<FutureStringArray> {
    return super.result() as Promise<FutureStringArray>;
  }
}
class FutureNumberArray extends FutureArray {
  /** Returns `FutureNumber` at given index. */
  override at(index: number) {
    return new FutureNumber(this.directive.next(index));
  }

  /** Returns the result for `FutureNumberArray` once it's node has been run. */
  protected override async result(): Promise<FutureNumberArray> {
    return super.result() as Promise<FutureNumberArray>;
  }
}
/**  */
class ErrorOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new ErrorOut(this.directive.next(index));
  }

  /** Returns the result for `ErrorOutArray` once it's node has been run. */
  protected override async result(): Promise<ErrorOutArray> {
    return super.result() as Promise<ErrorOutArray>;
  }
}
/** ErrorOut */
class ErrorOut extends FutureObject {
  ...
  get type() {
    return new FutureString(this.directive.next("type"));
  }
  /** A message providing more details about the error. */
  get message() {
    return new FutureString(this.directive.next("message"));
  }
...
class GenerateTextInArray extends FutureArray {
  ...
  override at(index: number) {
    return new GenerateTextIn(this.directive.next(index));
  }

  /** Returns the result for `GenerateTextInArray` once it's node has been run. */
  protected override async result(): Promise<GenerateTextInArray> {
    return super.result() as Promise<GenerateTextInArray>;
  }
}
/** GenerateTextIn */
class GenerateTextIn extends FutureObject {
  /** Input prompt. */
  get prompt() {
    return new FutureString(this.directive.next("prompt"));
  }
  ...
  get temperature() {
    return new FutureNumber(this.directive.next("temperature"));
  }
  /** (Optional) Maximum number of tokens to generate. */
  get max_tokens() {
    return new FutureNumber(this.directive.next("max_tokens"));
  }
  /** (Optional) Selected node. */
  get node() {
    return new FutureString(this.directive.next("node"));
  }
...
class GenerateTextOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new GenerateTextOut(this.directive.next(index));
  }

  /** Returns the result for `GenerateTextOutArray` once it's node has been run. */
  protected override async result(): Promise<GenerateTextOutArray> {
    return super.result() as Promise<GenerateTextOutArray>;
  }
}
/** GenerateTextOut */
...
class GenerateJSONInArray extends FutureArray {
  ...
  override at(index: number) {
    return new GenerateJSONIn(this.directive.next(index));
  }

  /** Returns the result for `GenerateJSONInArray` once it's node has been run. */
  protected override async result(): Promise<GenerateJSONInArray> {
    return super.result() as Promise<GenerateJSONInArray>;
  }
}
/** GenerateJSONIn */
class GenerateJSONIn extends FutureObject {
  ...
  get json_schema() {
    return new FutureAnyObject(this.directive.next("json_schema"));
  }
  /** (Optional) Sampling temperature to use. Higher values make the output more random, lower values make the output more deterministic. */
  get temperature() {
    return new FutureNumber(this.directive.next("temperature"));
...
class GenerateJSONOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new GenerateJSONOut(this.directive.next(index));
  }

  /** Returns the result for `GenerateJSONOutArray` once it's node has been run. */
  protected override async result(): Promise<GenerateJSONOutArray> {
    return super.result() as Promise<GenerateJSONOutArray>;
  }
}
/** GenerateJSONOut */
class GenerateJSONOut extends FutureObject {
  /** JSON response. */
  get json_object() {
    return new FutureAnyObject(this.directive.next("json_object"));
  }
...
class MultiGenerateTextInArray extends FutureArray {
  ...
  override at(index: number) {
    return new MultiGenerateTextIn(this.directive.next(index));
  }

  /** Returns the result for `MultiGenerateTextInArray` once it's node has been run. */
  protected override async result(): Promise<MultiGenerateTextInArray> {
    return super.result() as Promise<MultiGenerateTextInArray>;
  }
}
/** MultiGenerateTextIn */
class MultiGenerateTextIn extends FutureObject {
  ...
  get num_choices() {
    return new FutureNumber(this.directive.next("num_choices"));
  }
  /** (Optional) Sampling temperature to use. Higher values make the output more random, lower values make the output more deterministic. */
  get temperature() {
    return new FutureNumber(this.directive.next("temperature"));
...
class MultiGenerateTextOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new MultiGenerateTextOut(this.directive.next(index));
  }

  /** Returns the result for `MultiGenerateTextOutArray` once it's node has been run. */
  protected override async result(): Promise<MultiGenerateTextOutArray> {
    return super.result() as Promise<MultiGenerateTextOutArray>;
  }
}
...
class MultiGenerateTextOut extends FutureObject {
  /** array */
  get choices() {
    return new MultiGenerateTextOutArray(this.directive.next("choices"));
  }
...
class MultiGenerateJSONInArray extends FutureArray {
  ...
  override at(index: number) {
    return new MultiGenerateJSONIn(this.directive.next(index));
  }

  /** Returns the result for `MultiGenerateJSONInArray` once it's node has been run. */
  protected override async result(): Promise<MultiGenerateJSONInArray> {
    return super.result() as Promise<MultiGenerateJSONInArray>;
  }
}
/** MultiGenerateJSONIn */
...
class MultiGenerateJSONOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new MultiGenerateJSONOut(this.directive.next(index));
  }

  /** Returns the result for `MultiGenerateJSONOutArray` once it's node has been run. */
  protected override async result(): Promise<MultiGenerateJSONOutArray> {
    return super.result() as Promise<MultiGenerateJSONOutArray>;
  }
}
...
class MultiGenerateJSONOut extends FutureObject {
  /** array */
  get choices() {
    return new MultiGenerateJSONOutArray(this.directive.next("choices"));
  }
...
class Mistral7BInstructInArray extends FutureArray {
  ...
  override at(index: number) {
    return new Mistral7BInstructIn(this.directive.next(index));
  }

  /** Returns the result for `Mistral7BInstructInArray` once it's node has been run. */
  protected override async result(): Promise<Mistral7BInstructInArray> {
    return super.result() as Promise<Mistral7BInstructInArray>;
  }
}
/** Mistral7BInstructIn */
...
class Mistral7BInstructChoiceArray extends FutureArray {
  ...
  override at(index: number) {
    return new Mistral7BInstructChoice(this.directive.next(index));
  }

  /** Returns the result for `Mistral7BInstructChoiceArray` once it's node has been run. */
  protected override async result(): Promise<Mistral7BInstructChoiceArray> {
    return super.result() as Promise<Mistral7BInstructChoiceArray>;
  }
}
...
class Mistral7BInstructOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new Mistral7BInstructOut(this.directive.next(index));
  }

  /** Returns the result for `Mistral7BInstructOutArray` once it's node has been run. */
  protected override async result(): Promise<Mistral7BInstructOutArray> {
    return super.result() as Promise<Mistral7BInstructOutArray>;
  }
}
...
class Mistral7BInstructOut extends FutureObject {
  /** array */
  get choices() {
    return new Mistral7BInstructOutArray(this.directive.next("choices"));
  }
...
class GenerateTextVisionInArray extends FutureArray {
  ...
  override at(index: number) {
    return new GenerateTextVisionIn(this.directive.next(index));
  }

  /** Returns the result for `GenerateTextVisionInArray` once it's node has been run. */
  protected override async result(): Promise<GenerateTextVisionInArray> {
    return super.result() as Promise<GenerateTextVisionInArray>;
  }
}
...
class GenerateTextVisionIn extends FutureObject {
  ...
  /** Image prompts. */
  get image_uris() {
    return new FutureStringArray(this.directive.next("image_uris"));
  }
  /** (Optional) Sampling temperature to use. Higher values make the output more random, lower values make the output more deterministic. */
  get temperature() {
    return new FutureNumber(this.directive.next("temperature"));
...
class GenerateTextVisionOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new GenerateTextVisionOut(this.directive.next(index));
  }

  /** Returns the result for `GenerateTextVisionOutArray` once it's node has been run. */
  protected override async result(): Promise<GenerateTextVisionOutArray> {
    return super.result() as Promise<GenerateTextVisionOutArray>;
  }
}
...
class Firellava13BInArray extends FutureArray {
  ...
  override at(index: number) {
    return new Firellava13BIn(this.directive.next(index));
  }

  /** Returns the result for `Firellava13BInArray` once it's node has been run. */
  protected override async result(): Promise<Firellava13BInArray> {
    return super.result() as Promise<Firellava13BInArray>;
  }
}
/** Firellava13BIn */
...
class Firellava13BOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new Firellava13BOut(this.directive.next(index));
  }

  /** Returns the result for `Firellava13BOutArray` once it's node has been run. */
  protected override async result(): Promise<Firellava13BOutArray> {
    return super.result() as Promise<Firellava13BOutArray>;
  }
}
/** Firellava13BOut */
...
class GenerateImageInArray extends FutureArray {
  ...
  override at(index: number) {
    return new GenerateImageIn(this.directive.next(index));
  }

  /** Returns the result for `GenerateImageInArray` once it's node has been run. */
  protected override async result(): Promise<GenerateImageInArray> {
    return super.result() as Promise<GenerateImageInArray>;
  }
}
/** GenerateImageIn */
class GenerateImageIn extends FutureObject {
  ...
  get store() {
    return new FutureString(this.directive.next("store"));
  }
  /** (Optional) Selected node. */
  get node() {
    return new FutureString(this.directive.next("node"));
...
class GenerateImageOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new GenerateImageOut(this.directive.next(index));
  }

  /** Returns the result for `GenerateImageOutArray` once it's node has been run. */
  protected override async result(): Promise<GenerateImageOutArray> {
    return super.result() as Promise<GenerateImageOutArray>;
  }
}
/** GenerateImageOut */
...
class MultiGenerateImageInArray extends FutureArray {
  ...
  override at(index: number) {
    return new MultiGenerateImageIn(this.directive.next(index));
  }

  /** Returns the result for `MultiGenerateImageInArray` once it's node has been run. */
  protected override async result(): Promise<MultiGenerateImageInArray> {
    return super.result() as Promise<MultiGenerateImageInArray>;
  }
}
...
class MultiGenerateImageIn extends FutureObject {
  ...
  get num_images() {
    return new FutureNumber(this.directive.next("num_images"));
  }
  /** (Optional) Use "hosted" to return an image URL hosted on Substrate. You can also provide a URL to a registered [file store](/docs/file-stores). If unset, the image data will be returned as a base64-encoded string. */
  get store() {
    return new FutureString(this.directive.next("store"));
...
class MultiGenerateImageOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new MultiGenerateImageOut(this.directive.next(index));
  }

  /** Returns the result for `MultiGenerateImageOutArray` once it's node has been run. */
  protected override async result(): Promise<MultiGenerateImageOutArray> {
    return super.result() as Promise<MultiGenerateImageOutArray>;
  }
}
...
class MultiGenerateImageOut extends FutureObject {
  /** array */
  get outputs() {
    return new MultiGenerateImageOutArray(this.directive.next("outputs"));
  }
...
class StableDiffusionXLInArray extends FutureArray {
  ...
  override at(index: number) {
    return new StableDiffusionXLIn(this.directive.next(index));
  }

  /** Returns the result for `StableDiffusionXLInArray` once it's node has been run. */
  protected override async result(): Promise<StableDiffusionXLInArray> {
    return super.result() as Promise<StableDiffusionXLInArray>;
  }
}
/** StableDiffusionXLIn */
class StableDiffusionXLIn extends FutureObject {
  ...
  get negative_prompt() {
    return new FutureString(this.directive.next("negative_prompt"));
  }
  /** (Optional) Number of diffusion steps. */
  get steps() {
    return new FutureNumber(this.directive.next("steps"));
  }
...
class StableDiffusionImageArray extends FutureArray {
  ...
  override at(index: number) {
    return new StableDiffusionImage(this.directive.next(index));
  }

  /** Returns the result for `StableDiffusionImageArray` once it's node has been run. */
  protected override async result(): Promise<StableDiffusionImageArray> {
    return super.result() as Promise<StableDiffusionImageArray>;
  }
}
...
class StableDiffusionImage extends FutureObject {
  ...
  get seed() {
    return new FutureNumber(this.directive.next("seed"));
  }
...
class StableDiffusionXLOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new StableDiffusionXLOut(this.directive.next(index));
  }

  /** Returns the result for `StableDiffusionXLOutArray` once it's node has been run. */
  protected override async result(): Promise<StableDiffusionXLOutArray> {
    return super.result() as Promise<StableDiffusionXLOutArray>;
  }
}
...
class StableDiffusionXLOut extends FutureObject {
  /** array */
  get outputs() {
    return new StableDiffusionXLOutArray(this.directive.next("outputs"));
  }
...
class StableDiffusionXLIPAdapterInArray extends FutureArray {
  ...
  override at(index: number) {
    return new StableDiffusionXLIPAdapterIn(this.directive.next(index));
  }

  /** Returns the result for `StableDiffusionXLIPAdapterInArray` once it's node has been run. */
  protected override async result(): Promise<StableDiffusionXLIPAdapterInArray> {
    return super.result() as Promise<StableDiffusionXLIPAdapterInArray>;
  }
}
...
class StableDiffusionXLIPAdapterIn extends FutureObject {
  ...
  get image_prompt_uri() {
    return new FutureString(this.directive.next("image_prompt_uri"));
  }
  /** Number of images to generate. */
  get num_images() {
    return new FutureNumber(this.directive.next("num_images"));
  ...
  get ip_adapter_scale() {
    return new FutureNumber(this.directive.next("ip_adapter_scale"));
  }
  /** (Optional) Negative input prompt. */
  get negative_prompt() {
    return new FutureString(this.directive.next("negative_prompt"));
...
class StableDiffusionXLIPAdapterOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new StableDiffusionXLIPAdapterOut(this.directive.next(index));
  }

  /** Returns the result for `StableDiffusionXLIPAdapterOutArray` once it's node has been run. */
  protected override async result(): Promise<StableDiffusionXLIPAdapterOutArray> {
    return super.result() as Promise<StableDiffusionXLIPAdapterOutArray>;
  }
}
...
class StableDiffusionXLIPAdapterOut extends FutureObject {
  /** array */
  get outputs() {
    return new StableDiffusionXLIPAdapterOutArray(
      this.directive.next("outputs"),
    );
  }
...
class StableDiffusionXLControlNetInArray extends FutureArray {
  ...
  override at(index: number) {
    return new StableDiffusionXLControlNetIn(this.directive.next(index));
  }

  /** Returns the result for `StableDiffusionXLControlNetInArray` once it's node has been run. */
  protected override async result(): Promise<StableDiffusionXLControlNetInArray> {
    return super.result() as Promise<StableDiffusionXLControlNetInArray>;
  }
}
...
class StableDiffusionXLControlNetIn extends FutureObject {
  ...
  get control_method() {
    return new FutureString(this.directive.next("control_method"));
  }
  /** Text prompt. */
  get prompt() {
    return new FutureString(this.directive.next("prompt"));
  ...
  get output_resolution() {
    return new FutureNumber(this.directive.next("output_resolution"));
  }
  /** (Optional) Negative input prompt. */
  get negative_prompt() {
    return new FutureString(this.directive.next("negative_prompt"));
  ...
  get conditioning_scale() {
    return new FutureNumber(this.directive.next("conditioning_scale"));
  }
  /** (Optional) Random noise seeds. Default is random seeds for each generation. */
  get seeds() {
    return new FutureNumberArray(this.directive.next("seeds"));
...
class StableDiffusionXLControlNetOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new StableDiffusionXLControlNetOut(this.directive.next(index));
  }

  /** Returns the result for `StableDiffusionXLControlNetOutArray` once it's node has been run. */
  protected override async result(): Promise<StableDiffusionXLControlNetOutArray> {
    return super.result() as Promise<StableDiffusionXLControlNetOutArray>;
  }
}
...
class StableDiffusionXLControlNetOut extends FutureObject {
  /** array */
  get outputs() {
    return new StableDiffusionXLControlNetOutArray(
      this.directive.next("outputs"),
    );
  }
...
class GenerativeEditImageInArray extends FutureArray {
  ...
  override at(index: number) {
    return new GenerativeEditImageIn(this.directive.next(index));
  }

  /** Returns the result for `GenerativeEditImageInArray` once it's node has been run. */
  protected override async result(): Promise<GenerativeEditImageInArray> {
    return super.result() as Promise<GenerativeEditImageInArray>;
  }
}
...
class GenerativeEditImageOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new GenerativeEditImageOut(this.directive.next(index));
  }

  /** Returns the result for `GenerativeEditImageOutArray` once it's node has been run. */
  protected override async result(): Promise<GenerativeEditImageOutArray> {
    return super.result() as Promise<GenerativeEditImageOutArray>;
  }
}
...
class MultiGenerativeEditImageInArray extends FutureArray {
  ...
  override at(index: number) {
    return new MultiGenerativeEditImageIn(this.directive.next(index));
  }

  /** Returns the result for `MultiGenerativeEditImageInArray` once it's node has been run. */
  protected override async result(): Promise<MultiGenerativeEditImageInArray> {
    return super.result() as Promise<MultiGenerativeEditImageInArray>;
  }
}
...
class MultiGenerativeEditImageOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new MultiGenerativeEditImageOut(this.directive.next(index));
  }

  /** Returns the result for `MultiGenerativeEditImageOutArray` once it's node has been run. */
  protected override async result(): Promise<MultiGenerativeEditImageOutArray> {
    return super.result() as Promise<MultiGenerativeEditImageOutArray>;
  }
}
...
class MultiGenerativeEditImageOut extends FutureObject {
  /** array */
  get outputs() {
    return new MultiGenerativeEditImageOutArray(this.directive.next("outputs"));
  }
...
class StableDiffusionXLInpaintInArray extends FutureArray {
  ...
  override at(index: number) {
    return new StableDiffusionXLInpaintIn(this.directive.next(index));
  }

  /** Returns the result for `StableDiffusionXLInpaintInArray` once it's node has been run. */
  protected override async result(): Promise<StableDiffusionXLInpaintInArray> {
    return super.result() as Promise<StableDiffusionXLInpaintInArray>;
  }
}
...
class StableDiffusionXLInpaintIn extends FutureObject {
  ...
  get strength() {
    return new FutureNumber(this.directive.next("strength"));
  }
  /** (Optional) Random noise seeds. Default is random seeds for each generation. */
  get seeds() {
    return new FutureNumberArray(this.directive.next("seeds"));
...
class StableDiffusionXLInpaintOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new StableDiffusionXLInpaintOut(this.directive.next(index));
  }

  /** Returns the result for `StableDiffusionXLInpaintOutArray` once it's node has been run. */
  protected override async result(): Promise<StableDiffusionXLInpaintOutArray> {
    return super.result() as Promise<StableDiffusionXLInpaintOutArray>;
  }
}
...
class StableDiffusionXLInpaintOut extends FutureObject {
  /** array */
  get outputs() {
    return new StableDiffusionXLInpaintOutArray(this.directive.next("outputs"));
  }
...
class BoundingBoxArray extends FutureArray {
  ...
  override at(index: number) {
    return new BoundingBox(this.directive.next(index));
  }

  /** Returns the result for `BoundingBoxArray` once it's node has been run. */
  protected override async result(): Promise<BoundingBoxArray> {
    return super.result() as Promise<BoundingBoxArray>;
  }
}
/** BoundingBox */
class BoundingBox extends FutureObject {
  /** Top left corner x. */
  get x1() {
    return new FutureNumber(this.directive.next("x1"));
  }
  /** Top left corner y. */
  get y1() {
    return new FutureNumber(this.directive.next("y1"));
  }
  /** Bottom right corner x. */
  get x2() {
    return new FutureNumber(this.directive.next("x2"));
  }
  /** Bottom right corner y. */
  get y2() {
    return new FutureNumber(this.directive.next("y2"));
  }
...
class PointArray extends FutureArray {
  ...
  override at(index: number) {
    return new Point(this.directive.next(index));
  }

  /** Returns the result for `PointArray` once it's node has been run. */
  protected override async result(): Promise<PointArray> {
    return super.result() as Promise<PointArray>;
  }
}
/** Point */
class Point extends FutureObject {
  /** X position. */
  get x() {
    return new FutureNumber(this.directive.next("x"));
  }
  /** Y position. */
  get y() {
    return new FutureNumber(this.directive.next("y"));
  }
...
class FillMaskInArray extends FutureArray {
  ...
  override at(index: number) {
    return new FillMaskIn(this.directive.next(index));
  }

  /** Returns the result for `FillMaskInArray` once it's node has been run. */
  protected override async result(): Promise<FillMaskInArray> {
    return super.result() as Promise<FillMaskInArray>;
  }
}
/** FillMaskIn */
...
class FillMaskOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new FillMaskOut(this.directive.next(index));
  }

  /** Returns the result for `FillMaskOutArray` once it's node has been run. */
  protected override async result(): Promise<FillMaskOutArray> {
    return super.result() as Promise<FillMaskOutArray>;
  }
}
/** FillMaskOut */
...
class BigLaMaInArray extends FutureArray {
  ...
  override at(index: number) {
    return new BigLaMaIn(this.directive.next(index));
  }

  /** Returns the result for `BigLaMaInArray` once it's node has been run. */
  protected override async result(): Promise<BigLaMaInArray> {
    return super.result() as Promise<BigLaMaInArray>;
  }
}
/** BigLaMaIn */
...
class BigLaMaOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new BigLaMaOut(this.directive.next(index));
  }

  /** Returns the result for `BigLaMaOutArray` once it's node has been run. */
  protected override async result(): Promise<BigLaMaOutArray> {
    return super.result() as Promise<BigLaMaOutArray>;
  }
}
/** BigLaMaOut */
...
class RemoveBackgroundInArray extends FutureArray {
  ...
  override at(index: number) {
    return new RemoveBackgroundIn(this.directive.next(index));
  }

  /** Returns the result for `RemoveBackgroundInArray` once it's node has been run. */
  protected override async result(): Promise<RemoveBackgroundInArray> {
    return super.result() as Promise<RemoveBackgroundInArray>;
  }
}
/** RemoveBackgroundIn */
class RemoveBackgroundIn extends FutureObject {
  ...
  get return_mask() {
    return new (this.directive.next("return_mask"))();
  }
  /** (Optional) Hex value background color. Transparent if unset. */
  get background_color() {
    return new FutureString(this.directive.next("background_color"));
  }
  /** (Optional) Use "hosted" to return an image URL hosted on Substrate. You can also provide a URL to a registered [file store](/docs/file-stores). If unset, the image data will be returned as a base64-encoded string. */
  get store() {
    return new FutureString(this.directive.next("store"));
...
class RemoveBackgroundOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new RemoveBackgroundOut(this.directive.next(index));
  }

  /** Returns the result for `RemoveBackgroundOutArray` once it's node has been run. */
  protected override async result(): Promise<RemoveBackgroundOutArray> {
    return super.result() as Promise<RemoveBackgroundOutArray>;
  }
}
/** RemoveBackgroundOut */
...
class DISISNetInArray extends FutureArray {
  ...
  override at(index: number) {
    return new DISISNetIn(this.directive.next(index));
  }

  /** Returns the result for `DISISNetInArray` once it's node has been run. */
  protected override async result(): Promise<DISISNetInArray> {
    return super.result() as Promise<DISISNetInArray>;
  }
}
/** DISISNetIn */
...
class DISISNetOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new DISISNetOut(this.directive.next(index));
  }

  /** Returns the result for `DISISNetOutArray` once it's node has been run. */
  protected override async result(): Promise<DISISNetOutArray> {
    return super.result() as Promise<DISISNetOutArray>;
  }
}
/** DISISNetOut */
...
class UpscaleImageInArray extends FutureArray {
  ...
  override at(index: number) {
    return new UpscaleImageIn(this.directive.next(index));
  }

  /** Returns the result for `UpscaleImageInArray` once it's node has been run. */
  protected override async result(): Promise<UpscaleImageInArray> {
    return super.result() as Promise<UpscaleImageInArray>;
  }
}
/** UpscaleImageIn */
...
class UpscaleImageOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new UpscaleImageOut(this.directive.next(index));
  }

  /** Returns the result for `UpscaleImageOutArray` once it's node has been run. */
  protected override async result(): Promise<UpscaleImageOutArray> {
    return super.result() as Promise<UpscaleImageOutArray>;
  }
}
/** UpscaleImageOut */
...
class RealESRGANInArray extends FutureArray {
  ...
  override at(index: number) {
    return new RealESRGANIn(this.directive.next(index));
  }

  /** Returns the result for `RealESRGANInArray` once it's node has been run. */
  protected override async result(): Promise<RealESRGANInArray> {
    return super.result() as Promise<RealESRGANInArray>;
  }
}
/** RealESRGANIn */
...
class RealESRGANOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new RealESRGANOut(this.directive.next(index));
  }

  /** Returns the result for `RealESRGANOutArray` once it's node has been run. */
  protected override async result(): Promise<RealESRGANOutArray> {
    return super.result() as Promise<RealESRGANOutArray>;
  }
}
/** RealESRGANOut */
...
class SegmentUnderPointInArray extends FutureArray {
  ...
  override at(index: number) {
    return new SegmentUnderPointIn(this.directive.next(index));
  }

  /** Returns the result for `SegmentUnderPointInArray` once it's node has been run. */
  protected override async result(): Promise<SegmentUnderPointInArray> {
    return super.result() as Promise<SegmentUnderPointInArray>;
  }
}
/** SegmentUnderPointIn */
class SegmentUnderPointIn extends FutureObject {
  ...
  /** Point prompt. */
  get point() {
    return new (this.directive.next("point"))();
  }
  /** (Optional) Use "hosted" to return an image URL hosted on Substrate. You can also provide a URL to a registered [file store](/docs/file-stores). If unset, the image data will be returned as a base64-encoded string. */
  get store() {
    return new FutureString(this.directive.next("store"));
...
class SegmentUnderPointOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new SegmentUnderPointOut(this.directive.next(index));
  }

  /** Returns the result for `SegmentUnderPointOutArray` once it's node has been run. */
  protected override async result(): Promise<SegmentUnderPointOutArray> {
    return super.result() as Promise<SegmentUnderPointOutArray>;
  }
}
...
class SegmentAnythingInArray extends FutureArray {
  ...
  override at(index: number) {
    return new SegmentAnythingIn(this.directive.next(index));
  }

  /** Returns the result for `SegmentAnythingInArray` once it's node has been run. */
  protected override async result(): Promise<SegmentAnythingInArray> {
    return super.result() as Promise<SegmentAnythingInArray>;
  }
}
/** SegmentAnythingIn */
class SegmentAnythingIn extends FutureObject {
  ...
  get point_prompts() {
    return new SegmentAnythingInArray(this.directive.next("point_prompts"));
  }
  /** (Optional) Box prompts, to detect a segment within the bounding box. One of `point_prompts` or `box_prompts` must be set. */
  get box_prompts() {
    return new SegmentAnythingInArray(this.directive.next("box_prompts"));
  }
  /** (Optional) Use "hosted" to return an image URL hosted on Substrate. You can also provide a URL to a registered [file store](/docs/file-stores). If unset, the image data will be returned as a base64-encoded string. */
  get store() {
    return new FutureString(this.directive.next("store"));
...
class SegmentAnythingOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new SegmentAnythingOut(this.directive.next(index));
  }

  /** Returns the result for `SegmentAnythingOutArray` once it's node has been run. */
  protected override async result(): Promise<SegmentAnythingOutArray> {
    return super.result() as Promise<SegmentAnythingOutArray>;
  }
}
/** SegmentAnythingOut */
...
class TranscribeMediaInArray extends FutureArray {
  ...
  override at(index: number) {
    return new TranscribeMediaIn(this.directive.next(index));
  }

  /** Returns the result for `TranscribeMediaInArray` once it's node has been run. */
  protected override async result(): Promise<TranscribeMediaInArray> {
    return super.result() as Promise<TranscribeMediaInArray>;
  }
}
/** TranscribeMediaIn */
class TranscribeMediaIn extends FutureObject {
  ...
  get language() {
    return new FutureString(this.directive.next("language"));
  }
  /** (Optional) Segment the text into sentences with approximate timestamps. */
  get segment() {
    return new (this.directive.next("segment"))();
  }
...
class TranscribedWordArray extends FutureArray {
  ...
  override at(index: number) {
    return new TranscribedWord(this.directive.next(index));
  }

  /** Returns the result for `TranscribedWordArray` once it's node has been run. */
  protected override async result(): Promise<TranscribedWordArray> {
    return super.result() as Promise<TranscribedWordArray>;
  }
}
/** TranscribedWord */
class TranscribedWord extends FutureObject {
  /** Text of word. */
  get word() {
    return new FutureString(this.directive.next("word"));
  }
  /** (Optional) Start time of word, in seconds. */
  get start() {
    return new FutureNumber(this.directive.next("start"));
  }
  /** (Optional) End time of word, in seconds. */
  get end() {
    return new FutureNumber(this.directive.next("end"));
  }
  /** (Optional) ID of speaker, if `diarize` is enabled. */
  get speaker() {
    return new FutureString(this.directive.next("speaker"));
  }
...
class TranscribedSegmentArray extends FutureArray {
  ...
  override at(index: number) {
    return new TranscribedSegment(this.directive.next(index));
  }

  /** Returns the result for `TranscribedSegmentArray` once it's node has been run. */
  protected override async result(): Promise<TranscribedSegmentArray> {
    return super.result() as Promise<TranscribedSegmentArray>;
  }
}
/** TranscribedSegment */
class TranscribedSegment extends FutureObject {
  ...
  get words() {
    return new TranscribedSegmentArray(this.directive.next("words"));
  }
...
class ChapterMarkerArray extends FutureArray {
  ...
  override at(index: number) {
    return new ChapterMarker(this.directive.next(index));
  }

  /** Returns the result for `ChapterMarkerArray` once it's node has been run. */
  protected override async result(): Promise<ChapterMarkerArray> {
    return super.result() as Promise<ChapterMarkerArray>;
  }
}
/** ChapterMarker */
class ChapterMarker extends FutureObject {
  /** Chapter title. */
  get title() {
    return new FutureString(this.directive.next("title"));
  }
...
class TranscribeMediaOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new TranscribeMediaOut(this.directive.next(index));
  }

  /** Returns the result for `TranscribeMediaOutArray` once it's node has been run. */
  protected override async result(): Promise<TranscribeMediaOutArray> {
    return super.result() as Promise<TranscribeMediaOutArray>;
  }
}
/** TranscribeMediaOut */
class TranscribeMediaOut extends FutureObject {
  ...
  get segments() {
    return new TranscribeMediaOutArray(this.directive.next("segments"));
  }
  /** (Optional) Chapter markers, if `suggest_chapters` is enabled. */
  get chapters() {
    return new TranscribeMediaOutArray(this.directive.next("chapters"));
  }
...
class GenerateSpeechInArray extends FutureArray {
  ...
  override at(index: number) {
    return new GenerateSpeechIn(this.directive.next(index));
  }

  /** Returns the result for `GenerateSpeechInArray` once it's node has been run. */
  protected override async result(): Promise<GenerateSpeechInArray> {
    return super.result() as Promise<GenerateSpeechInArray>;
  }
}
/** GenerateSpeechIn */
...
class GenerateSpeechOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new GenerateSpeechOut(this.directive.next(index));
  }

  /** Returns the result for `GenerateSpeechOutArray` once it's node has been run. */
  protected override async result(): Promise<GenerateSpeechOutArray> {
    return super.result() as Promise<GenerateSpeechOutArray>;
  }
}
/** GenerateSpeechOut */
...
class XTTSV2InArray extends FutureArray {
  ...
  override at(index: number) {
    return new XTTSV2In(this.directive.next(index));
  }

  /** Returns the result for `XTTSV2InArray` once it's node has been run. */
  protected override async result(): Promise<XTTSV2InArray> {
    return super.result() as Promise<XTTSV2InArray>;
  }
}
/** XTTSV2In */
...
class XTTSV2OutArray extends FutureArray {
  ...
  override at(index: number) {
    return new XTTSV2Out(this.directive.next(index));
  }

  /** Returns the result for `XTTSV2OutArray` once it's node has been run. */
  protected override async result(): Promise<XTTSV2OutArray> {
    return super.result() as Promise<XTTSV2OutArray>;
  }
}
/** XTTSV2Out */
...
class EmbeddingArray extends FutureArray {
  ...
  override at(index: number) {
    return new Embedding(this.directive.next(index));
  }

  /** Returns the result for `EmbeddingArray` once it's node has been run. */
  protected override async result(): Promise<EmbeddingArray> {
    return super.result() as Promise<EmbeddingArray>;
  }
}
/** Embedding */
class Embedding extends FutureObject {
  /** Embedding vector. */
  get vector() {
    return new FutureNumberArray(this.directive.next("vector"));
  }
  /** (Optional) Vector store document ID. */
  get doc_id() {
    return new FutureString(this.directive.next("doc_id"));
  }
  /** (Optional) Vector store document metadata. */
  get metadata() {
    return new FutureAnyObject(this.directive.next("metadata"));
  }
...
class EmbedTextInArray extends FutureArray {
  ...
  override at(index: number) {
    return new EmbedTextIn(this.directive.next(index));
  }

  /** Returns the result for `EmbedTextInArray` once it's node has been run. */
  protected override async result(): Promise<EmbedTextInArray> {
    return super.result() as Promise<EmbedTextInArray>;
  }
}
/** EmbedTextIn */
class EmbedTextIn extends FutureObject {
  ...
  get embedded_metadata_keys() {
    return new FutureStringArray(this.directive.next("embedded_metadata_keys"));
  }
...
class EmbedTextOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new EmbedTextOut(this.directive.next(index));
  }

  /** Returns the result for `EmbedTextOutArray` once it's node has been run. */
  protected override async result(): Promise<EmbedTextOutArray> {
    return super.result() as Promise<EmbedTextOutArray>;
  }
}
/** EmbedTextOut */
...
class NoneArray extends FutureArray {
  ...
  override at(index: number) {
    return new None(this.directive.next(index));
  }

  /** Returns the result for `NoneArray` once it's node has been run. */
  protected override async result(): Promise<NoneArray> {
    return super.result() as Promise<NoneArray>;
  }
}
/** None */
class None extends FutureObject {
  ...
  protected override async result(): Promise<None> {
    return super.result() as Promise<None>;
  }
}
/**  */
class MultiEmbedTextInArray extends FutureArray {
  ...
  override at(index: number) {
    return new MultiEmbedTextIn(this.directive.next(index));
  }

  /** Returns the result for `MultiEmbedTextInArray` once it's node has been run. */
  protected override async result(): Promise<MultiEmbedTextInArray> {
    return super.result() as Promise<MultiEmbedTextInArray>;
  }
}
/** MultiEmbedTextIn */
class MultiEmbedTextIn extends FutureObject {
  /** Items to embed. */
  get items() {
    return new MultiEmbedTextInArray(this.directive.next("items"));
  }
  /** (Optional) [Vector store](/docs/vector-stores) identifier. */
  get store() {
    return new FutureString(this.directive.next("store"));
...
class MultiEmbedTextOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new MultiEmbedTextOut(this.directive.next(index));
  }

  /** Returns the result for `MultiEmbedTextOutArray` once it's node has been run. */
  protected override async result(): Promise<MultiEmbedTextOutArray> {
    return super.result() as Promise<MultiEmbedTextOutArray>;
  }
}
/** MultiEmbedTextOut */
class MultiEmbedTextOut extends FutureObject {
  ...
  get embeddings() {
    return new MultiEmbedTextOutArray(this.directive.next("embeddings"));
  }
...
class JinaV2InArray extends FutureArray {
  ...
  override at(index: number) {
    return new JinaV2In(this.directive.next(index));
  }

  /** Returns the result for `JinaV2InArray` once it's node has been run. */
  protected override async result(): Promise<JinaV2InArray> {
    return super.result() as Promise<JinaV2InArray>;
  }
}
/** JinaV2In */
class JinaV2In extends FutureObject {
  /** Items to embed. */
  get items() {
    return new JinaV2InArray(this.directive.next("items"));
  }
  /** (Optional) [Vector store](/docs/vector-stores) identifier. */
  get store() {
    return new FutureString(this.directive.next("store"));
...
class JinaV2OutArray extends FutureArray {
  ...
  override at(index: number) {
    return new JinaV2Out(this.directive.next(index));
  }

  /** Returns the result for `JinaV2OutArray` once it's node has been run. */
  protected override async result(): Promise<JinaV2OutArray> {
    return super.result() as Promise<JinaV2OutArray>;
  }
}
/** JinaV2Out */
class JinaV2Out extends FutureObject {
  /** Generated embeddings. */
  get embeddings() {
    return new JinaV2OutArray(this.directive.next("embeddings"));
  }
...
class EmbedImageInArray extends FutureArray {
  ...
  override at(index: number) {
    return new EmbedImageIn(this.directive.next(index));
  }

  /** Returns the result for `EmbedImageInArray` once it's node has been run. */
  protected override async result(): Promise<EmbedImageInArray> {
    return super.result() as Promise<EmbedImageInArray>;
  }
}
/** EmbedImageIn */
...
class EmbedImageOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new EmbedImageOut(this.directive.next(index));
  }

  /** Returns the result for `EmbedImageOutArray` once it's node has been run. */
  protected override async result(): Promise<EmbedImageOutArray> {
    return super.result() as Promise<EmbedImageOutArray>;
  }
}
/** EmbedImageOut */
...
class MultiEmbedImageInArray extends FutureArray {
  ...
  override at(index: number) {
    return new MultiEmbedImageIn(this.directive.next(index));
  }

  /** Returns the result for `MultiEmbedImageInArray` once it's node has been run. */
  protected override async result(): Promise<MultiEmbedImageInArray> {
    return super.result() as Promise<MultiEmbedImageInArray>;
  }
}
/** MultiEmbedImageIn */
class MultiEmbedImageIn extends FutureObject {
  /** Items to embed. */
  get items() {
    return new MultiEmbedImageInArray(this.directive.next("items"));
  }
  /** (Optional) [Vector store](/docs/vector-stores) identifier. */
  get store() {
    return new FutureString(this.directive.next("store"));
...
class MultiEmbedImageOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new MultiEmbedImageOut(this.directive.next(index));
  }

  /** Returns the result for `MultiEmbedImageOutArray` once it's node has been run. */
  protected override async result(): Promise<MultiEmbedImageOutArray> {
    return super.result() as Promise<MultiEmbedImageOutArray>;
  }
}
/** MultiEmbedImageOut */
class MultiEmbedImageOut extends FutureObject {
  /** Generated embeddings. */
  get embeddings() {
    return new MultiEmbedImageOutArray(this.directive.next("embeddings"));
  }
...
class CLIPInArray extends FutureArray {
  ...
  override at(index: number) {
    return new CLIPIn(this.directive.next(index));
  }

  /** Returns the result for `CLIPInArray` once it's node has been run. */
  protected override async result(): Promise<CLIPInArray> {
    return super.result() as Promise<CLIPInArray>;
  }
}
/** CLIPIn */
class CLIPIn extends FutureObject {
  /** Items to embed. */
  get items() {
    return new CLIPInArray(this.directive.next("items"));
  }
...
class CLIPOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new CLIPOut(this.directive.next(index));
  }

  /** Returns the result for `CLIPOutArray` once it's node has been run. */
  protected override async result(): Promise<CLIPOutArray> {
    return super.result() as Promise<CLIPOutArray>;
  }
}
/** CLIPOut */
class CLIPOut extends FutureObject {
  /** Generated embeddings. */
  get embeddings() {
    return new CLIPOutArray(this.directive.next("embeddings"));
  }
...
class CreateVectorStoreInArray extends FutureArray {
  ...
  override at(index: number) {
    return new CreateVectorStoreIn(this.directive.next(index));
  }

  /** Returns the result for `CreateVectorStoreInArray` once it's node has been run. */
  protected override async result(): Promise<CreateVectorStoreInArray> {
    return super.result() as Promise<CreateVectorStoreInArray>;
  }
}
/** CreateVectorStoreIn */
class CreateVectorStoreIn extends FutureObject {
  ...
  get m() {
    return new FutureNumber(this.directive.next("m"));
  }
  /** (Optional) The size of the dynamic candidate list for constructing the index graph. */
  get ef_construction() {
    return new FutureNumber(this.directive.next("ef_construction"));
  }
...
class CreateVectorStoreOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new CreateVectorStoreOut(this.directive.next(index));
  }

  /** Returns the result for `CreateVectorStoreOutArray` once it's node has been run. */
  protected override async result(): Promise<CreateVectorStoreOutArray> {
    return super.result() as Promise<CreateVectorStoreOutArray>;
  }
}
...
class ListVectorStoresInArray extends FutureArray {
  ...
  override at(index: number) {
    return new ListVectorStoresIn(this.directive.next(index));
  }

  /** Returns the result for `ListVectorStoresInArray` once it's node has been run. */
  protected override async result(): Promise<ListVectorStoresInArray> {
    return super.result() as Promise<ListVectorStoresInArray>;
  }
}
/** ListVectorStoresIn */
...
class ListVectorStoresOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new ListVectorStoresOut(this.directive.next(index));
  }

  /** Returns the result for `ListVectorStoresOutArray` once it's node has been run. */
  protected override async result(): Promise<ListVectorStoresOutArray> {
    return super.result() as Promise<ListVectorStoresOutArray>;
  }
}
/** ListVectorStoresOut */
class ListVectorStoresOut extends FutureObject {
  ...
  get stores() {
    return new ListVectorStoresOutArray(this.directive.next("stores"));
  }
...
class DeleteVectorStoreInArray extends FutureArray {
  ...
  override at(index: number) {
    return new DeleteVectorStoreIn(this.directive.next(index));
  }

  /** Returns the result for `DeleteVectorStoreInArray` once it's node has been run. */
  protected override async result(): Promise<DeleteVectorStoreInArray> {
    return super.result() as Promise<DeleteVectorStoreInArray>;
  }
}
/** DeleteVectorStoreIn */
...
class DeleteVectorStoreOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new DeleteVectorStoreOut(this.directive.next(index));
  }

  /** Returns the result for `DeleteVectorStoreOutArray` once it's node has been run. */
  protected override async result(): Promise<DeleteVectorStoreOutArray> {
    return super.result() as Promise<DeleteVectorStoreOutArray>;
  }
}
...
class VectorArray extends FutureArray {
  ...
  override at(index: number) {
    return new Vector(this.directive.next(index));
  }

  /** Returns the result for `VectorArray` once it's node has been run. */
  protected override async result(): Promise<VectorArray> {
    return super.result() as Promise<VectorArray>;
  }
}
/** Canonical representation of document with embedding vector. */
class Vector extends FutureObject {
  /** Document ID. */
  get id() {
    return new FutureString(this.directive.next("id"));
  }
  /** Embedding vector. */
  get vector() {
    return new FutureNumberArray(this.directive.next("vector"));
...
class FetchVectorsInArray extends FutureArray {
  ...
  override at(index: number) {
    return new FetchVectorsIn(this.directive.next(index));
  }

  /** Returns the result for `FetchVectorsInArray` once it's node has been run. */
  protected override async result(): Promise<FetchVectorsInArray> {
    return super.result() as Promise<FetchVectorsInArray>;
  }
}
/** FetchVectorsIn */
class FetchVectorsIn extends FutureObject {
  ...
  get ids() {
    return new FutureStringArray(this.directive.next("ids"));
  }
...
class FetchVectorsOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new FetchVectorsOut(this.directive.next(index));
  }

  /** Returns the result for `FetchVectorsOutArray` once it's node has been run. */
  protected override async result(): Promise<FetchVectorsOutArray> {
    return super.result() as Promise<FetchVectorsOutArray>;
  }
}
/** FetchVectorsOut */
class FetchVectorsOut extends FutureObject {
  /** Retrieved vectors. */
  get vectors() {
    return new FetchVectorsOutArray(this.directive.next("vectors"));
  }
...
class UpdateVectorsOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new UpdateVectorsOut(this.directive.next(index));
  }

  /** Returns the result for `UpdateVectorsOutArray` once it's node has been run. */
  protected override async result(): Promise<UpdateVectorsOutArray> {
    return super.result() as Promise<UpdateVectorsOutArray>;
  }
}
/** UpdateVectorsOut */
class UpdateVectorsOut extends FutureObject {
  ...
  get count() {
    return new FutureNumber(this.directive.next("count"));
  }
...
class DeleteVectorsOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new DeleteVectorsOut(this.directive.next(index));
  }

  /** Returns the result for `DeleteVectorsOutArray` once it's node has been run. */
  protected override async result(): Promise<DeleteVectorsOutArray> {
    return super.result() as Promise<DeleteVectorsOutArray>;
  }
}
/** DeleteVectorsOut */
...
class UpdateVectorParamsArray extends FutureArray {
  ...
  override at(index: number) {
    return new UpdateVectorParams(this.directive.next(index));
  }

  /** Returns the result for `UpdateVectorParamsArray` once it's node has been run. */
  protected override async result(): Promise<UpdateVectorParamsArray> {
    return super.result() as Promise<UpdateVectorParamsArray>;
  }
}
/** UpdateVectorParams */
...
class UpdateVectorsParamsArray extends FutureArray {
  ...
  override at(index: number) {
    return new UpdateVectorsParams(this.directive.next(index));
  }

  /** Returns the result for `UpdateVectorsParamsArray` once it's node has been run. */
  protected override async result(): Promise<UpdateVectorsParamsArray> {
    return super.result() as Promise<UpdateVectorsParamsArray>;
  }
}
/** UpdateVectorsParams */
class UpdateVectorsParams extends FutureObject {
  ...
  /** Vectors to upsert. */
  get vectors() {
    return new UpdateVectorsParamsArray(this.directive.next("vectors"));
  }
  /** returns the result for `UpdateVectorsParams` once it's node has been run. */
  protected override async result(): Promise<UpdateVectorsParams> {
    return super.result() as Promise<UpdateVectorsParams>;
  }
}
/**  */
class DeleteVectorsInArray extends FutureArray {
  ...
  override at(index: number) {
    return new DeleteVectorsIn(this.directive.next(index));
  }

  /** Returns the result for `DeleteVectorsInArray` once it's node has been run. */
  protected override async result(): Promise<DeleteVectorsInArray> {
    return super.result() as Promise<DeleteVectorsInArray>;
  }
}
/** DeleteVectorsIn */
...
class QueryVectorStoreInArray extends FutureArray {
  ...
  override at(index: number) {
    return new QueryVectorStoreIn(this.directive.next(index));
  }

  /** Returns the result for `QueryVectorStoreInArray` once it's node has been run. */
  protected override async result(): Promise<QueryVectorStoreInArray> {
    return super.result() as Promise<QueryVectorStoreInArray>;
  }
}
/** QueryVectorStoreIn */
class QueryVectorStoreIn extends FutureObject {
  ...
  get query_ids() {
    return new FutureStringArray(this.directive.next("query_ids"));
  }
  /** (Optional) Image URIs to embed and use for the query. */
  get query_image_uris() {
    return new FutureStringArray(this.directive.next("query_image_uris"));
  }
  /** (Optional) Vector to use for the query. */
  get query_vectors() {
    return new FutureArrayArray(this.directive.next("query_vectors"));
  }
  /** (Optional) Texts to embed and use for the query. */
  get query_strings() {
    return new FutureStringArray(this.directive.next("query_strings"));
  }
  /** (Optional) Number of results to return. */
  get top_k() {
    return new FutureNumber(this.directive.next("top_k"));
  }
  /** (Optional) The size of the dynamic candidate list for searching the index graph. */
  get ef_search() {
    return new FutureNumber(this.directive.next("ef_search"));
  }
  /** (Optional) Include the values of the vectors in the response. */
  get include_values() {
    return new (this.directive.next("include_values"))();
  }
  /** (Optional) Include the metadata of the vectors in the response. */
  get include_metadata() {
    return new (this.directive.next("include_metadata"))();
  }
  /** (Optional) Filter metadata by key-value pairs. */
  get filters() {
    return new FutureAnyObject(this.directive.next("filters"));
  }
...
class VectorStoreQueryResultArray extends FutureArray {
  ...
  override at(index: number) {
    return new VectorStoreQueryResult(this.directive.next(index));
  }

  /** Returns the result for `VectorStoreQueryResultArray` once it's node has been run. */
  protected override async result(): Promise<VectorStoreQueryResultArray> {
    return super.result() as Promise<VectorStoreQueryResultArray>;
  }
}
...
class VectorStoreQueryResult extends FutureObject {
  ...
  /** Similarity score. */
  get distance() {
    return new FutureNumber(this.directive.next("distance"));
  }
  /** (Optional) Embedding vector. */
  get vector() {
    return new FutureNumberArray(this.directive.next("vector"));
...
class QueryVectorStoreOutArray extends FutureArray {
  ...
  override at(index: number) {
    return new QueryVectorStoreOut(this.directive.next(index));
  }

  /** Returns the result for `QueryVectorStoreOutArray` once it's node has been run. */
  protected override async result(): Promise<QueryVectorStoreOutArray> {
    return super.result() as Promise<QueryVectorStoreOutArray>;
  }
}
/** QueryVectorStoreOut */
class QueryVectorStoreOut extends FutureObject {
  /** Query results. */
  get results() {
    return new FutureArrayArray(this.directive.next("results"));
  }
...
export class UpdateVectors extends Node {
  ...
  constructor(
    args: AlsoAcceptFutures<
      OpenAPI.components["schemas"]["UpdateVectorsParams"]
    >,
  ) {
    super(args);
  }
